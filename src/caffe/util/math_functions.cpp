...
template <>
void caffe_gpu_l2norm<double>(const int n, const double* x, double* out){
  CUBLAS_CHECK(cublasDnrm2(Caffe::cublas_handle(), n, x, 1, out));  
}

template <>
void caffe_gpu_l2norm<float>(const int n, const float* x, float* out){
